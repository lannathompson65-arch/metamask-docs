...
const sidebar = {
  overview: [
    ...
    { type: "doc", id: "get-started", label: "Get Started" },
    {
      ...
      collapsed: false,
      items: [
        { type: "link", label: "React Hooks", href: "/embedded-wallets/sdk/react" },
        { type: "link", label: "Vue Composables", href: "/embedded-wallets/sdk/vue" },
        { type: "link", label: "JavaScript (All Frameworks)", href: "/embedded-wallets/sdk/js" },
        ...
        { type: "link", label: "Node.js (Server-side)", href: "/embedded-wallets/sdk/node" },
      ],
    },
    {
      type: "category",
  ...
  sdk_react: [
    ...
    "sdk/react/README",
    {
      ...
      items: [
        ...
        "sdk/react/advanced/external-wallets",
        "sdk/react/advanced/server-side-verification",
        "sdk/react/advanced/session-management",
        "sdk/react/advanced/user-account-dashboard",
        "sdk/react/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_vue: [
    ...
    "sdk/vue/README",
    {
      ...
      items: [
        ...
        "sdk/vue/advanced/external-wallets",
        "sdk/vue/advanced/server-side-verification",
        "sdk/vue/advanced/session-management",
        "sdk/vue/advanced/user-account-dashboard",
        "sdk/vue/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_js: [
    ...
    "sdk/js/README",
    {
      ...
      items: [
        ...
        "sdk/js/advanced/external-wallets",
        "sdk/js/advanced/server-side-verification",
        "sdk/js/advanced/session-management",
        "sdk/js/advanced/user-account-dashboard",
        "sdk/js/advanced/wallet-pregeneration",
      ],
    },
    "sdk/js/events",
    {
  ...
  sdk_android: [
    ...
    "sdk/android/README",
    {
      ...
      items: [
        ...
        "sdk/android/advanced/server-side-verification",
        "sdk/android/advanced/session-management",
        "sdk/android/advanced/user-account-dashboard",
        "sdk/android/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_ios: [
    ...
    "sdk/ios/README",
    {
      ...
      items: [
        ...
        "sdk/ios/advanced/server-side-verification",
        "sdk/ios/advanced/session-management",
        "sdk/ios/advanced/user-account-dashboard",
        "sdk/ios/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_react_native: [
    ...
    "sdk/react-native/README",
    {
      ...
      items: [
        ...
        "sdk/react-native/advanced/server-side-verification",
        "sdk/react-native/advanced/session-management",
        "sdk/react-native/advanced/user-account-dashboard",
        "sdk/react-native/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_flutter: [
    ...
    "sdk/flutter/README",
    {
      ...
      items: [
        ...
        "sdk/flutter/advanced/server-side-verification",
        "sdk/flutter/advanced/session-management",
        "sdk/flutter/advanced/user-account-dashboard",
        "sdk/flutter/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_unity: [
    ...
    "sdk/unity/README",
    {
      ...
      items: [
        ...
        "sdk/unity/advanced/server-side-verification",
        "sdk/unity/advanced/session-management",
        "sdk/unity/advanced/user-account-dashboard",
        "sdk/unity/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
  ...
  sdk_node: [
    ...
    "sdk/node/private-key",
    {
      ...
      label: "Advanced",
      items: [
        "sdk/node/advanced/server-side-verification",
        "sdk/node/advanced/session-management",
        "sdk/node/advanced/user-account-dashboard",
        "sdk/node/advanced/wallet-pregeneration",
      ],
    },
    "sdk/node/examples",
    {
  ...
  sdk_unreal: [
    ...
    "sdk/unreal/README",
    {
      ...
      items: [
        ...
        "sdk/unreal/advanced/server-side-verification",
        "sdk/unreal/advanced/session-management",
        "sdk/unreal/advanced/user-account-dashboard",
        "sdk/unreal/advanced/wallet-pregeneration",
      ],
    },
    {
      type: "category",
