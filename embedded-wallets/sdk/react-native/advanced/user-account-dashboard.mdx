...
Users access the dashboard after authenticating with any app that uses MetaMask Embedded Wallets. Open the dashboard in-app using the WebBrowser module, or prompt users to visit [account.web3auth.io](https://account.web3auth.io) directly.
