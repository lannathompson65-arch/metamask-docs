...
description: 'Give users a central place to manage their Embedded Wallet account | Embedded Wallets'
---
...
Users access the dashboard after authenticating with any app that uses MetaMask Embedded Wallets. You can open it via the in-app browser (using `SFSafariViewController` or `ASWebAuthenticationSession`) or prompt users to visit [account.web3auth.io](https://account.web3auth.io) directly.

:::tip

For a smoother experience, add a "Manage account" or "Security" link to [account.web3auth.io](https://account.web3auth.io) in your app's settings/profile screen.
