...
Users access the dashboard after authenticating with any app that uses MetaMask Embedded Wallets. From your backend-driven application, redirect or link users to [account.web3auth.io](https://account.web3auth.io).

:::tip

For a smoother experience, surface a "Manage account" or "Security" link to [account.web3auth.io](https://account.web3auth.io) in your app's frontend.
