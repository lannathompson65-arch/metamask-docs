...
Users access the dashboard after authenticating with any app that uses MetaMask Embedded Wallets. Open the dashboard in a WebView or prompt users to visit [account.web3auth.io](https://account.web3auth.io) directly from within the game.

:::tip

For a smoother experience, add a "Manage account" or "Security" button to your game's settings/profile menu that links to [account.web3auth.io](https://account.web3auth.io).
