...
This API only returns the Core Kit / SFA Key wallet addresses. To use the wallet addresses with the Embedded Wallet SDKs, you will need to use the `useCoreKitKey` flag when initializing the Android SDK.
