...
Users access the dashboard after authenticating with any app that uses MetaMask Embedded Wallets. You can open it in-app using `url_launcher` or prompt users to visit [account.web3auth.io](https://account.web3auth.io) directly.
